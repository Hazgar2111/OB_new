...
def connect_node(request):  # New
    if request.method == 'POST':
        ...
        response = {
            'message': 'All the nodes are now connected. The Hazgarcoin Blockchain now contains the following nodes:',
...
# Replacing the chain by the longest chain if needed  [consensus mechanism]
